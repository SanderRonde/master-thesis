...
const BASE_DIR = path.join(METRICS_DIR, `collectors/cow-components-vue3`);

export const cowComponentsVue3Metrics = preserveCommandBuilder(
	cmd('cow-components-vue3-metrics')
		.desc('Collect cow-components-vue3 metrics')
		.args({
			'no-cache': flag(),
			prod: flag(),
		})
