...
const BASE_DIR = path.join(
	METRICS_DIR,
	`collectors/cow-components-lit-element`
);

export const cowComponentsLitElementMetrics = preserveCommandBuilder(
	cmd('cow-components-lit-element-metrics')
		.desc('Collect cow-components-lit-element metrics')
		.args({
			'no-cache': flag(),
			prod: flag(),
		})
