...
import { getRenderTimeHTMLTemplate } from '../../../../collectors/cow-components-basic/cow-components-angular/templates/render-time-html-template';
import { getRenderTimeJsTemplate } from '../../../../collectors/cow-components-basic/cow-components-angular/templates/render-time-js-template';
...
const BASE_DIR = path.join(
	METRICS_DIR,
	`collectors/cow-components-basic/cow-components-angular`
);

export const ANGULAR_DEMO_DIR = path.join(DEMO_REPO_DIR_BASIC, 'angular');
...
export const cowComponentsAngularMetrics = registerMetricsCommand(
	...
	await collectSameAsDashboardBasicMetrics(exec, 'angular');
