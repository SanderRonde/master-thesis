...
import { extractComponentTypes } from '../../../../../submodules/30mhz-dashboard-basic/src/lib/design-library-wrappers/build/scripts/lib/extract-component-types';
import { getNamedCowComponents } from '../../../../../submodules/30mhz-dashboard-basic/src/lib/design-library-wrappers/build/scripts/lib/extract-cow-tag-names';
import { createReactComponent } from '../../../../../submodules/30mhz-dashboard-basic/src/lib/design-library-wrappers/react/scripts/lib/create-react-component';
import {
	defaultValuesTemplate,
	getNamespacedPropDemoDefaultValueName,
} from '../../../../../submodules/30mhz-dashboard-basic/src/lib/storybook/scripts/lib/templates/default-values-template';
...
const APP_MODULE_FILE_PATH = path.join(BASIC_DASHBOARD_DIR, 'src/app/app.module.ts');
const NOT_FOUND_COMPONENT_BASE = path.join(BASIC_DASHBOARD_DIR, 'src/app/shared/404');
const HACK_CSS_FILE_PATH = path.join(BASIC_DASHBOARD_DIR, 'src/styles/hack.scss');
