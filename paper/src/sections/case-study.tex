...
\begin{itemize}
  ...
  \item \emph{Bundling:} Build artifacts generated in the previous step are spread out over a number of files. Since we want to provide developers with a single bundle that contains all of the required code, we bundle these various files up into a single file.
