...
\begin{lstlisting}[language={JavaScript},caption={A change made to an event listener. The definition of \emph{unwrapEvent} can be seen in Listing~\ref{lst:case-study:event-handler-unwrap-event}},label={lst:case-study:event-handler-change}]
// before
...
\begin{lstlisting}[language={JavaScript},caption={The \emph{unwrapEvent} function},label={lst:case-study:event-handler-unwrap-event}]
