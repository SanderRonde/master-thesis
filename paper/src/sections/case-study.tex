...
After collecting this data, we are able to generate the various JS frameworks. The process of which is described in detail below.

\subsubsection{React Wrapper}
\todo{}

\subsubsection{Svelte Wrapper}
\todo{}

\subsubsection{Angular Wrapper}
\todo{}
