...
\subsection{Machine specifications}\label{sec:experimental-setup:machine-specs}
...
In order to eliminate variations as much as possible, we artificially slow down the speed of the processor by a factor of \slowdownFactorLoadTime{} by using the \code{Emulation.setCPUThrottlingRate} command~\footurl{https://chromedevtools.github.io/devtools-protocol/tot/Emulation/\#method-setCPUThrottlingRate}. We also perform this operation \loadTimePerformanceMeasures{} times and average the results.
