...
\\
\\
\textbf{RQ1: How viable is the process of migrating Angular components to Web Components?}
\\
In answering this research question, we aim to assess the feasibility of migrating Angular components to Web Components. This research question can be boiled down to two sub-research questions.
\\
\\
\textbf{SRQ1: How technically viable is the process of migrating Angular components to Web Components?}
\\
...
\\
\\
\textbf{SRQ2: How viable is the process of migrating Angular components to Web Components for businesses?}
\\
